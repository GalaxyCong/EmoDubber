...
class Denoiser(torch.nn.Module):
    ...
    def __init__(self, vocoder, filter_length=1024, n_overlap=4, win_length=640, mode="zeros"):
        super().__init__()
        self.filter_length = 640 # filter_length
        self.hop_length = 160 # int(filter_length / n_overlap)
        self.win_length = 640 # win_length
