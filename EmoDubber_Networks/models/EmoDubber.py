...
class EmoDubber_all(BaseLightningClass):
    ...
    def synthesise(self, x, x_lengths, Lip, lip_lengths, n_timesteps, temperature=1.0, spks=None, GT_sim=None, VAfeature=None, pitch=None, energy=None, mel_LLM=None, length_scale=1.0):
